  ...
  return function(t) {
    ...
    var i = n(48),
      r = {
        ...
        parsePadding: function(t) {
          var e, n, i, a;
          return r.isNumber(t) || r.isString(t) ? e = i = a = n = t : r.isArray(t) && (e = t[0], n = r.isNil(t[1]) ? t[0] : t[1], i = r.isNil(t[2]) ? t[0] : t[2], a = r.isNil(t[3]) ? n : t[3]), [e, n, i, a]
        }
      };
    r.Array = {
      merge: function(t) {
    ...
    var a = n(0),
      ...
      f = function(t) {
        ...
        return n.getDefaultCfg = function() {
          ...
          var r = {};
          r.field = e, n ? a.isFunction(n) ? r.callback = n : r.values = n : r.values = i, this._setAttrOptions(t, r)
          ...
          return r && r.style && (i.style = e.getCallbackCfg(r.fields, r.style, t._origin)), e.get("generatePoints") && (i.points = t.points), n && (i.center = e.get("coord").center), i
        }, n.draw = function(t, e) {
          var n = this,
            i = n.get("container"),
            r = n.getYScale();
    ...
    t.exports = {
      getBBoxFromPoints: function(t) {
        if (0 !== t.length) {
          for (var e = t[0], n = e.x, i = e.x, r = e.y, a = e.y, o = t.length, s = 1; s < o; s++) e = t[s], n = Math.min(n, e.x), i = Math.max(i, e.x), r = Math.min(r, e.y), a = Math.max(a, e.y);
          return {
            minX: n,
            minY: r,
            maxX: i,
      ...
      getBBoxFromArc: function(t, e, n, i, r, a) {
        ...
        s[0] = Math.cos(i) * n + t, s[1] = Math.sin(i) * n + e, c[0] = Math.cos(r) * n + t, c[1] = Math.sin(r) * n + e;
        var h = [0, 0],
          f = [0, 0];
        if (o.min(h, s, c), o.max(f, s, c), (i %= 2 * Math.PI) < 0 && (i += 2 * Math.PI), (r %= 2 * Math.PI) < 0 && (r += 2 * Math.PI), i > r && !a ? r += 2 * Math.PI : i < r && a && (i += 2 * Math.PI), a) {
          var p = r;
          r = i, i = p
        }
        for (var g = 0; g < r; g += Math.PI / 2) g > i && (u[0] = Math.cos(g) * n + t, u[1] = Math.sin(g) * n + e, o.min(h, u, h), o.max(f, u, f));
        return {
          minX: h[0],
          minY: h[1],
          maxX: f[0],
      ...
      getBBoxFromBezierGroup: function(t) {
        for (var e = 1 / 0, n = -1 / 0, i = 1 / 0, r = -1 / 0, o = 0, s = t.length; o < s; o++) {
          var c = a(t[o]);
          c.minX < e && (e = c.minX), c.maxX > n && (n = c.maxX), c.minY < i && (i = c.minY), c.maxY > r && (r = c.maxY)
        }
        return {
          minX: e,
          minY: i,
      ...
      a = function() {
        ...
        return e._initDefaultCfg = function() {}, e._getNormalizedValue = function(t, e) {
          ...
          var n = this,
            r = n.xScale,
            a = n.yScales;
          if (i.isFunction(e) && (e = e(r, a)), i.isString(e[0]) && -1 !== e[0].indexOf("%")) return this.parsePercentPoint(t, e);
    ...
    var a = n(67),
      ...
      u = function() {
        ...
        return t.prototype._getAttrValue = function(t, e) {
          ...
          for (var t = this.scales, e = this.callback, n = arguments.length, i = Array(n), r = 0; r < n; r++) i[r] = arguments[r];
          var a = i;
          if (e) {
    ...
    function s(t, e) {
      ...
      return l.each(t, function(t) {
        var i = [].concat(t.values),
          r = [].concat(e.values);
        t.type !== e.type || t.field !== e.field || i.sort(o).toString() !== r.sort(o).toString() || (n = !0)
      }), n
    }
    var c = n(32),
      u = n(60),
      ...
      m = function(t) {
        ...
        return n.getDefaultCfg = function() {
          ...
          var t = this;
          t._initCanvas(), t._initLayers(), t.set("geoms", []), t.set("scaleController", new p), t.set("axisController", new g({
          ...
          return l.isObject(t) ? l.mix(n, t) : n[t] = e, this.set("colDefs", n), this.get("scaleController").defs = n, this
        }, n.axis = function(t, e) {
          ...
          this.set("filteredData", r), this._initCoord(), e.plugins.notify(this, "beforeGeomInit"), this._initGeoms(n), this.get("syncY") && this._syncYScales(), this._adjustScale(), e.plugins.notify(this, "beforeGeomDraw"), this._renderAxis();
    ...
    var i = n(0),
      r = function() {
        function t(t) {
          ...
          var e, n;
          this.plot ? (e = this.plot.bl, n = this.plot.tr, this.start = e, this.end = n) : (e = this.start, n = this.end), this.init(e, n)
        }
        var e = t.prototype;
        ...
        return e._initDefaultCfg = function() {
          ...
          i.each(n, function(n) {
            ...
            n.attr(i.mix({
              x: s,
              y: c
            }, t.getTextAlignInfo(a, e), n.get("textStyle"))), n._id = t._id + "-" + n.attr("text"), r.add(n)
          })
          ...
          for (var t = 1 / 0, e = -1 / 0, n = 1 / 0, i = -1 / 0, r = this.get("children"), a = 0, o = r.length; a < o; a++) {
            ...
            if (c.get("visible")) {
              ...
              var l = [u.minX, u.minY],
                ...
                p = [u.maxX, u.maxY],
                g = c.attr("matrix");
              s.transformMat2d(l, l, g), s.transformMat2d(h, h, g), s.transformMat2d(f, f, g), s.transformMat2d(p, p, g), t = Math.min(l[0], h[0], f[0], p[0], t), e = Math.max(l[0], h[0], f[0], p[0], e), n = Math.min(l[1], h[1], f[1], p[1], n), i = Math.max(l[1], h[1], f[1], p[1], i)
            }
          }
          return {
            minX: t,
      ...
      h = function(t) {
        ...
        return a(e, t), e.prototype._initDefaultCfg = function() {
          ...
          var e = this.rangeMin(),
            n = this.rangeMax(),
            i = void 0;
          return (l(t) || -1 !== this.values.indexOf(t)) && (t = this.translate(t)), i = this.values.length > 1 ? t / (this.values.length - 1) : t, e + i * (n - e)
    ...
    t.exports = function(t) {
      var e = {},
        ...
        c = t.maxCount || 8,
        u = void 0;
      if (a ? 2 === (u = r(s - 1, c - 1) + 1) ? u = c : u < c - 4 && (u = c - 4) : u = c, !a && s <= u + u / 2) n = [].concat(o);
      else {
    ...
    function r(t, e, n, r) {
      var o, s, c, u, l, h, f, p, g = [],
        d = !!r;
      if (d) {
        for (c = [1 / 0, 1 / 0], u = [-1 / 0, -1 / 0], p = 0, f = t.length; p < f; p++) l = i(t[p]), a.min(c, c, l), a.max(u, u, l);
      ...
      for (p = 0, h = t.length; p < h; p++) {
        ...
        var _ = a.scale([], v, -y),
          ...
          b = a.add([], l, _),
          w = a.add([], l, S);
        d && (a.max(b, b, c), a.min(b, b, u), a.max(w, w, c), a.min(w, w, u)), g.push([b[0], b[1]]), g.push([w[0], w[1]])
      }
    ...
    t.exports = {
      smooth: function(t, e, n) {
        for (var i, a, o, s = !!e, c = r(t, .4, s, n), u = t.length, l = [], h = 0; h < u - 1; h++) i = c[2 * h], a = c[2 * h + 1], o = t[h + 1], l.push(["C", i[0], i[1], a[0], a[1], o.x, o.y]);
        ...
        getDefalutSize: function() {
          ...
          if (!t) {
            var e = this.get("coord"),
              ...
              s = 1 / a,
              c = 1;
            e && e.isPolar ? c = e.transposed && a > 1 ? i.widthRatio.multiplePie : i.widthRatio.rose : (n.isLinear && (s *= o[1] - o[0]), c = i.widthRatio.column), s *= c, this.hasAdjust("dodge") && (s /= r.length), t = s, this.set("defaultSize", t)
          }
          return t
        },
    ...
    var o = ["touchstart", "touchmove", "touchend"],
      s = function() {
        function t(t, e) {
          ...
          r.deepMix(this, n, t), this.chart = e, this.canvas = e.get("canvas"), this.el = e.get("canvas").get("el"), this._bindEvents()
        }
        var e = t.prototype;
        return e.getDefaultCfg = function() {
          return {
          ...
          var t = this.startEvent,
            ...
            r = this.resetEvent,
            a = this.el;
          i && (this.hammer = new i(a)), this._bindEvent(t, "_start"), this._bindEvent(e, "_process"), this._bindEvent(n, "_end"), this._bindEvent(r, "_reset")
        }, e._clearEvents = function() {
          var t = this.startEvent,
            e = this.processEvent,
            n = this.endEvent,
            i = this.resetEvent;
          this.hammer && (this.hammer.destroy(), this.hammer = null), this._clearTouchEvent(t, "_start"), this._clearTouchEvent(e, "_process"), this._clearTouchEvent(n, "_end"), this._clearTouchEvent(i, "_reset")
        }, e._bindEvent = function(t, e) {
          var n = this.el;
          t && (-1 !== o.indexOf(t) ? r.addEventListener(n, t, r.wrapBehavior(this, e)) : this.hammer && this.hammer.on(t, r.wrapBehavior(this, e)))
    ...
    var i = {},
      r = n(1);
    i.Global = r, i.version = r.version, i.Chart = n(15), i.Shape = n(6), i.G = n(7), i.Util = n(0), i.track = function(t) {
      r.trackable = t
    }, n(96), t.exports = i
  }, function(t, e, n) {
    var i = n(0),
    ...
    function i(t, e, n, s) {
      ...
      for (var c in e)
        if (e.hasOwnProperty(c)) {
          var u = e[c];
          null !== u && r(u) ? (r(t[c]) || (t[c] = {}), n < s ? i(t[c], u, n + 1, s) : t[c] = e[c]) : a(u) ? (t[c] = [], t[c] = t[c].concat(u)) : void 0 !== u && (t[c] = u)
        }
    }
    var r = n(31),
      a = n(17),
    ...
    var r = n(0),
      ...
      o = function(t) {
        function e(e) {
          var n;
          return n = t.call(this, e) || this, n.names = ["color"], n.type = "color", n.gradient = null, r.isString(n.values) && (n.linear = !0), n
        }
    ...
    var i = n(0),
      ...
      s = function() {
        ...
        return e._getDef = function(t) {
          ...
          var c = e[0][t];
          if (null === c && (c = i.Array.firstValue(e, t)), i.isNumber(t) || i.isNil(c) && !s) n = new a.Identity({
            value: t,
            field: t.toString(),
            values: [t]
          });
    ...
    t.exports = function(t) {
      ...
      if (e === g && n === d && p && (c = (n - e) / (y - 1)), i(e) && (e = 0), i(n) && (n = 0), n === e && (0 === e ? n = 1 : e > 0 ? e = 0 : n = 0, n - e < 5 && !c && n - e >= 1 && (c = 1)), i(c)) {
        var x = (n - e) / (v - 1);
        c = a.snapFactorTo(x, m, "ceil"), f !== h && ((y = parseInt((n - e) / c, 10)) > f && (y = f), y < h && (y = h), c = a.snapFactorTo((n - e) / (y - 1), m, "floor"))
      }
      if (r(u) && c < u && (c = u), t.interval || f !== h) n = Math.min(a.snapMultiple(n, c, "ceil"), d), e = Math.max(a.snapMultiple(e, c, "floor"), g), y = Math.round((n - e) / c), e = a.fixedBase(e, c), n = a.fixedBase(n, c);
      else {
        v = parseInt(v, 10);
        var _ = (n + e) / 2,
          ...
          w = S + b * c,
          P = void 0;
        P = v % 2 == 0 ? S - b * c : S - (b + 1) * c, w < n && (w += c), P > e && (P -= c), n = a.fixedBase(w, c), e = a.fixedBase(P, c)
      }
    ...
    var a = 12,
      o = {
        snapFactorTo: function(t, e, i) {
          ...
          var c = (t = "floor" === i ? o.snapFloor(e, t) : "ceil" === i ? o.snapCeiling(e, t) : o.snapTo(e, t)) * r;
      ...
      c = function() {
        ...
        return e._isHide = function(t) {
          ...
          var r = "",
            a = t.field,
            o = this.axisCfg;
          return o[a] && o[a].position ? r = o[a].position : "x" === e ? r = i ? "left" : "bottom" : "y" === e && (r = n ? "right" : "left", i && (r = "bottom")), r
          ...
          return r.each(l, function(t, e) {
            ...
            if (y) {
              var i = {};
              y.textAlign && (i.textAlign = y.textAlign), y.textBaseline && (i.textBaseline = y.textBaseline);
              var a = new s.Text({
          ...
          } else "x" === i && !h || "y" === i && h ? (c = o.axis.circle, a = "Circle", s = "circle") : (c = o.axis.radius, a = "Line", s = "radius");
          ...
          if (c._isAutoPadding()) {
            var u = r.parsePadding(c.get("padding")),
              ...
              f = ["auto" === u[0] ? h.top + 2 * l[0] : u[0], "auto" === u[1] ? h.right + l[1] : u[1], "auto" === u[2] ? h.bottom + l[2] : u[2], "auto" === u[3] ? h.left + l[3] : u[3]];
            if (t.isPolar) {
              var p = s.circle;
              if (p) {
                var g = p.maxHeight,
          ...
          r.each(s, function(e) {
            var n, s = e.type,
              ...
              f = e.position,
              p = e.index;
            if (t.isPolar ? "Line" === s ? n = o._getRadiusCfg(t) : "Circle" === s && (n = o._getCircleCfg(t)) : n = o._getLineCfg(t, h, f), c && u) {
              var g = [],
                d = i(u.getTicks());
              r.each(l, function(e) {
                var n = [];
    ...
    var i = n(0),
      ...
      s = function() {
        ...
        return e.get = function(t) {
          ...
          a || (a = i.getWidth(t));
          var o = e.get("height");
          o || (o = i.getHeight(t)), e.set("canvas", this), e.set("el", t), e.set("context", r || t.getContext("2d")), e.changeSize(a, o)
          ...
          function t() {
            ...
            try {
              for (var n = e._attrs.context, r = e._attrs.children, a = 0, s = r.length; a < s; a++) r[a].draw(n);
    ...
    var r = n(2),
      ...
      o = function(t) {
        ...
        return n._initProperties = function() {
          ...
          var u = Math.cos(r),
            l = Math.sin(r);
          t.moveTo(u * s + n, l * s + i), t.lineTo(u * o + n, l * o + i), t.arc(n, i, o, r, a, c), t.lineTo(Math.cos(a) * s + n, Math.sin(a) * s + i), 0 !== s && t.arc(n, i, s, a, r, !c), t.closePath()
        }, n.calculateBox = function() {
          var t = this.get("attrs"),
            e = t.x,
            n = t.y,
    ...
    var r = n(0),
      ...
      c = function(t) {
        ...
        return n._initProperties = function() {
            ...
            if (e.hasFill()) {
              ...
              if (r.isNil(p) || 1 === p || (t.globalAlpha = p), s)
                for (var g = 0, d = s.length; g < d; g++) {
                  var v = s[g];
                  f = o + g * (u + c) - l + c, "middle" === h && (f += l - c - (l - c) / 2), "top" === h && (f += l - c), t.fillText(v, a, f)
            ...
            if (e.hasStroke())
              if (s)
                for (var y = 0, m = s.length; y < m; y++) {
                  var x = s[y];
                  f = o + y * (u + c) - l + c, "middle" === h && (f += l - c - (l - c) / 2), "top" === h && (f += l - c), t.strokeText(x, a, f)
          ...
          return r && ("end" === r || "right" === r ? c.x -= o : "center" === r && (c.x -= o / 2)), a && ("top" === a ? c.y += s : "middle" === a && (c.y += s / 2)), {
            minX: c.x,
            minY: c.y,
            maxX: c.x + o,
            maxY: c.y + s
      ...
      draw: function(t, e) {
        ...
        if (t.isInCircle) {
          ...
          var u = t.center,
            ...
            m = s.length(p),
            x = s.length(g);
          return v >= 1.5 * Math.PI && (v -= 2 * Math.PI), y >= 1.5 * Math.PI && (y -= 2 * Math.PI), e.addShape("Sector", {
            className: "interval",
            attrs: a.mix({
              x: l,
              y: h,
      ...
      o = function() {
        ...
        return e.getDefaultCfg = function() {
          ...
          for (var t, e, n = this.maxLength, r = this.itemsGroup, a = this.itemGap, o = this.itemMarginBottom, s = this.itemWidth, c = this._titleHeight, u = r.get("children"), l = 0, h = 0, f = 0, p = [], g = 0, d = u.length; g < d; g++) {
            var v = u[g],
              y = v.getBBox();
            t = y.width, e = y.height, i.isNumber(s) ? h = s + a : t > h && (h = t + a), n - l < e ? (l = 0, f += h, v.moveTo(f, 0), p.push({
              x: f,
              y: c - e / 2,
              width: 1.375 * t,
              height: 1.375 * e
    ...
    var i = n(7).Matrix,
      ...
      a = {
        ...
        getAnimateParam: function(t, e, n) {
          var i = {};
          return t.delay && (i.delay = r.isFunction(t.delay) ? t.delay(e, n) : t.delay), i.easing = t.easing, i.duration = t.duration, i.delay = t.delay, i
        },
    ...
    function o(t, e, n) {
      ...
      return u.reverse(), c = i.parsePoints(c), u = i.parsePoints(u), t.isInCircle && (c.push(c[0]), u.unshift(u[u.length - 1]), r(u, t.center) && (u = [])), a(c, u, e, l, n)
    }
    var s = n(0),
      c = n(6),
      u = n(42),
    ...
    var o = function(t) {
      ...
      return n.getDefaultCfg = function() {
        ...
        if (!a.isArray(o) || !a.isArray(s)) {
          ...
          c.isCategory && u.isCategory ? (o = [o - l, o - l, o + l, o + l], s = [s - h, s + h, s + h, s - h]) : a.isArray(o) ? (o = [(n = o)[0], n[0], n[1], n[1]], s = [s - h / 2, s + h / 2, s + h / 2, s - h / 2]) : a.isArray(s) && (s = [(n = s)[0], n[1], n[1], n[0]], o = [o - l / 2, o - l / 2, o + l / 2, o + l / 2]), i.x = o, i.y = s
        }
        return i
      }, e
    }(r);
      ...
      d = function(t) {
        ...
        return a(e, t), e.prototype._initDefaultCfg = function() {
          ...
          var e = this.rangeMin(),
            ...
            i = this.translate(t),
            r = void 0;
          return r = 1 === this.values.length || isNaN(i) ? i : i > -1 ? i / (this.values.length - 1) : 0, e + r * (n - e)
    ...
    ! function(r) {
      ...
      S.dd = S.d, S.dddd = S.ddd, S.DD = S.D, S.mm = S.m, S.hh = S.H = S.HH = S.h, S.MM = S.M, S.ss = S.s, S.A = S.a, c.masks = {
    ...
    function r(t, e, n, i) {
      var r = [];
      return "left" === t && "top" === e ? (r[0] = 0, r[1] = 0) : "right" === t && "top" === e ? (r[0] = -n, r[1] = 0) : "left" === t && "bottom" === e ? (r[0] = 0, r[1] = Math.floor(-i)) : "right" === t && "bottom" === e ? (r[0] = Math.floor(-n), r[1] = Math.floor(-i)) : "right" === t && "middle" === e ? (r[0] = Math.floor(-n), r[1] = Math.floor(-i / 2)) : "left" === t && "middle" === e ? (r[0] = 0, r[1] = Math.floor(-i / 2)) : "center" === t && "bottom" === e ? (r[0] = Math.floor(-n / 2), r[1] = Math.floor(-i)) : "center" === t && "top" === e ? (r[0] = Math.floor(-n / 2), r[1] = 0) : (r[0] = Math.floor(-n / 2), r[1] = Math.floor(-i / 2)), r
    }
    ...
    var r = n(0),
      ...
      o = function(t) {
        ...
        var n = e.prototype;
        return n._initDefaultCfg = function() {
          this.type = "tag", this.position = null, this.content = null, this.direct = "tl", this.autoAdjust = !0, this.offsetX = 0, this.offsetY = 0, this.side = 4, this.background = {
            padding: 5,
            radius: 2,
            fill: "#1890FF"
          }, this.textStyle = {
          ...
          var p = "c" === h ? a : 0;
          return "l" === f && u - p - n < 0 ? f = "r" : "r" === f && u + p + n > s ? f = "l" : "c" === f && (n / 2 + u + p > s ? f = "l" : u - n / 2 - p < 0 && (f = "r")), r = h + f
        }, n.render = function(t, e) {
    ...
    var g = function() {
      function t(t) {
        this.enable = !0, this.cfg = {}, this.tooltip = null, this.chart = null, this.timeStamp = 0, l.mix(this, t);
        var e = this.chart;
      ...
      return e._setCrosshairsCfg = function() {
        ...
        if ("rect" === n) {
          var a, o, s, c, u = this.chart,
            ...
            v = i[i.length - 1],
            y = d.width;
          g.transposed ? (a = f.x, o = v.y - .75 * y, s = p.x - f.x, c = d.y - v.y + 1.5 * y) : (a = d.x - .75 * y, o = f.y, s = v.x - d.x + 1.5 * y, c = p.y - f.y), t.style = l.mix({
            x: a,
            y: o,
            width: s,
            height: c,
        ...
        if (e = c(e), a.onShow && a.onShow({
          ...
          r.setPosition(e);
          var h = n.items;
          a.showTooltipMarker && h.length ? (n = this._getTooltipMarkerStyle(n), r.setMarkers(n)) : r.clearMarkers(), r.show()
        }
            ...
            if (i.get("visible")) {
              ...
              l.each(f, function(t) {
                if (t.x && t.y) {
                  ...
                  }, n)), u.push(y), -1 !== ["line", "area", "path"].indexOf(s) ? (e = "circle", c.push(y)) : "interval" !== s || "cartesian" !== g.type && "rect" !== g.type || (e = "rect", y.width = i.getSize(t._origin), c.push(y))
                }
              })
            }
          }), u.length) {
        ...
        return e.getDefaultCfg = function() {
          ...
          if (o && o.moveTo(t[0].x, 0), e) {
            ...
            if (s) v = (g.x + d.x) / 2 - f / 2 + r;
              ...
              var m;
              if (m = t.length > 1 ? (t[0].x + t[t.length - 1].x) / 2 : t[0].x, (v = m - f / 2 + r) < g.x && (v = g.x), v + f > d.x && (v = d.x - f), c) {
                c.attr("points", [{
                  x: m - 3,
                  y: g.y - 4 + a
                }, {
    ...
    var o = function() {
      ...
      return e._toString = function(t) {
        ...
        i.each(r, function(i, r) {
          ...
          var c;
          "regionFilter" === i.type ? i.chart = n : c = i.top ? e.frontPlot : e.backPlot, i.coord = t, i.container = c, i.canvas = n.get("canvas");
          var u = i.render(t, c);
          if (u) {
            var l = e._getId(u, i);
      ...
      return e.addLegend = function(t, e, n) {
        ...
        if ("left" === n || "right" === n) {
          var m = t.verticalAlign || "middle",
            x = Math.abs(o.y - s.y);
          v = "left" === n ? p[3] : h - d - p[1], y = (x - g) / 2 + o.y, "top" === m ? y = o.y : "bottom" === m && (y = s.y - g), e && (y = e.get("y") - g - 12)
        } else {
          var _ = t.align || "left";
          if (v = p[3], "center" === _ ? v = h / 2 - d / 2 : "right" === _ && (v = h - (d + p[1])), y = "top" === n ? p[0] + Math.abs(t.container.getBBox().minY) : f - g, e) {
            var S = e.getWidth();
            v = e.x + S + 12
          }
        }
              ...
              r.each(e, function(e) {
                ...
                if (s.length) {
                  ...
                  r.each(o, function(r, a) {
                    if (t >= r.x + c && t <= r.x + r.width + c && n >= r.y + u && n <= r.height + r.y + u) return i = {
                      clickedItem: s[a],
                      clickedLegend: e
                    }, !1
                  })
    ...
    t.exports = {
      init: function(t) {
        ...
        t.set("legendController", e), t.legend = function(t, n) {
          var i = e.legendCfg;
          return e.enable = !0, r.isBoolean(t) ? (e.enable = t, i = n || {}) : r.isObject(t) ? i = t : i[t] = n, e.legendCfg = i, this
        }
      },
      beforeGeomDraw: function(t) {
        ...
        r.each(c, function(e, n) {
          ...
          r.each(e, function(t) {
            var e = t.getWidth(),
              i = t.getHeight();
            "top" === n || "bottom" === n ? (a = Math.max(a, i), t.offsetY > 0 && (a += t.offsetY)) : (a = Math.max(a, e), t.offsetX > 0 && (a += t.offsetX))
    ...
    function r(t, e, n) {
      var i, r = t.get("type"),
        ...
        u = s.field || "y",
        l = e[u];
      i = o.isIdentity ? o.value : e[c], a += "interval" === r || "schema" === r ? "-" + i : "line" === r || "area" === r || "path" === r ? "-" + r : o.isCategory ? "-" + i : "-" + i + "-" + l;
    ...
    function u(t, e, n) {
      ...
      f.each(e, function(e) {
        ...
        Object.keys(u).length && (r = s(e, n, "update", a.animation), f.isFunction(r) ? r(t, a, n) : (t.attr(o), t.animate().to({
          attrs: u,
          duration: a.duration,
          easing: a.easing,
          delay: a.delay
    ...
    var _ = {
      ...
      interval: function(t) {
        var e;
        return t.isPolar ? (e = m.groupScaleInXY, t.transposed && (e = m.groupWaveIn)) : e = t.transposed ? m.groupScaleInX : m.groupScaleInY, e
      },
      schema: function() {
      ...
      s = function() {
        ...
        return e.to = function(t) {
          ...
          for (var h in s) {
            var f = this.source[h],
              p = s[h];
            "points" === h ? (f = i(f), p = i(p), l.points = a(f, p), this.source.points = f, s.points = p) : "matrix" === h ? l.matrix = a(f, p) : l[h] = r(f, p)
          }
    ...
    var n = {
      ...
      elasticIn: function(t) {
        var e, n = .1,
          i = .4;
        return 0 === t ? 0 : 1 === t ? 1 : (i || (i = .3), !n || n < 1 ? (n = 1, e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / n), -n * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / i))
      },
      elasticOut: function(t) {
        var e, n = .1,
          i = .4;
        return 0 === t ? 0 : 1 === t ? 1 : (i || (i = .3), !n || n < 1 ? (n = 1, e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / n), n * Math.pow(2, -10 * t) * Math.sin((t - e) * (2 * Math.PI) / i) + 1)
      },
      elasticInOut: function(t) {
        var e, n = .1,
          i = .4;
        return 0 === t ? 0 : 1 === t ? 1 : (i || (i = .3), !n || n < 1 ? (n = 1, e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / n), (t *= 2) < 1 ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / i) * -.5 : n * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / i) * .5 + 1)
      },
      backIn: function(t) {
        var e = 1.70158;
        return t * t * ((e + 1) * t - e)
    ...
    function i(t, e, n, i, r) {
      ...
      "y" === r ? (o = l.x + f / 2, c = i.y < l.y ? i.y : l.y) : "x" === r ? (o = i.x > l.x ? i.x : l.x, c = l.y + p / 2) : "xy" === r && (n.isPolar ? (o = n.center.x, c = n.center.y) : (o = (l.x + h.x) / 2, c = (l.y + h.y) / 2));
    ...
    function r(t, e, n) {
      for (var i, r, o, s = t.get("children"), c = 0, u = s.length; c < u; c++) {
        var l = s[c],
          h = l.getBBox();
        i = (h.minX + h.maxX) / 2, r = (h.minY + h.maxY) / 2, o = a.getScaledMatrix(l, [i, r], n), a.doAnimation(l, {
          matrix: o
        }, e)
      }
    }
    ...
    t.exports = {
      ...
      _getLimitRange: function(t, e) {
        ...
        return "linear" === o ? (n = r.Array.getRange(s), e.min < n.min && (n.min = e.min), e.max > n.max && (n.max = e.max)) : "timeCat" === o ? (r.each(s, function(t, e) {
          s[e] = i.toTimeStamp(t)
        }), s.sort(function(t, e) {
          return t - e
        }), n = s) : n = s, n
            ...
            a.get("geoms").map(function(t) {
              ...
              return n.map(function(t) {
                if (t.get("isShape")) {
                  ...
                  s && (n.fill || n.fillStyle) && (n.fill = n.fillStyle = s), s && (n.stroke || n.strokeStyle) && (n.stroke = n.strokeStyle = s);
                  var i = {
                    attrs: n
                  };
                  "custom" !== e && "Custom" !== e || (i.createPath = t.get("createPath"), i.calculateBox = t.get("calculateBox")), a.addShape(e, i)
                }
                return t
    ...
    ! function(r, a, o, s) {
      ...
      function O(t, e, n) {
        var i = n.pointers.length,
          ...
          a = e & Ot && i - r == 0,
          o = e & (kt | It) && i - r == 0;
        n.isFirst = !!a, n.isFinal = !!o, a && (t.session = {}), n.eventType = e, D(t, n), t.emit("hammer.input", n), t.recognize(n), t.session.prevInput = n
      }
      ...
      function D(t, e) {
        var n = t.session,
          i = e.pointers,
          r = i.length;
        n.firstInput || (n.firstInput = E(e)), r > 1 && !n.firstMultiple ? n.firstMultiple = E(e) : 1 === r && (n.firstMultiple = !1);
        var a = n.firstInput,
          o = n.firstMultiple,
          s = o ? o.center : a.center,
          c = e.center = F(i);
        e.timeStamp = _t(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = R(s, c), e.distance = B(s, c), k(n, e), e.offsetDirection = N(e.deltaX, e.deltaY);
        var u = Y(e.deltaTime, e.deltaX, e.deltaY);
        e.overallVelocityX = u.x, e.overallVelocityY = u.y, e.overallVelocity = xt(u.x) > xt(u.y) ? u.x : u.y, e.scale = o ? z(o.pointers, i) : 1, e.rotation = o ? j(o.pointers, i) : 0, e.maxPointers = n.prevInput ? e.pointers.length > n.prevInput.maxPointers ? e.pointers.length : n.prevInput.maxPointers : e.pointers.length, I(n, e);
        var l = t.element;
      ...
      function V(t, e) {
        ...
        for (r = 0; r < o.length;) i[o[r].identifier] && s.push(o[r]), e & (kt | It) && delete i[o[r].identifier], r++;
      ...
      f(X, A, {
        handler: function(t) {
          var e = Wt[t.type];
          e & Ot && 0 === t.button && (this.pressed = !0), e & Dt && 1 !== t.which && (e = kt), this.pressed && (e & kt && (this.pressed = !1), this.callback(this.manager, e, {
            pointers: [t],
            changedPointers: [t],
            pointerType: "mouse",
            srcEvent: t
      ...
      r.MSPointerEvent && !r.PointerEvent && (Ut = "MSPointerDown", Zt = "MSPointerMove MSPointerUp MSPointerCancel"), f(L, A, {
        handler: function(t) {
          var e = this.store,
            n = !1,
          ...
          r & Ot && (0 === t.button || o) ? s < 0 && (e.push(t), s = e.length - 1) : r & (kt | It) && (n = !0), s < 0 || (e[s] = t, this.callback(this.manager, r, {
            pointers: e,
            changedPointers: [t],
            pointerType: a,
            srcEvent: t
      ...
      f(W, A, {
        handler: function(t) {
          ...
          if (e === Ot && (this.started = !0), this.started) {
            ...
            e & (kt | It) && n[0].length - n[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {
              pointers: n[0],
              changedPointers: n[1],
              pointerType: "touch",
              srcEvent: t
      ...
      Q.prototype = {
        ...
        emit: function(t) {
          ...
          var n = this,
            i = this.state;
          i < ge && e(n.options.event + tt(i)), e(n.options.event), t.additionalEvent && e(t.additionalEvent), i >= ge && e(n.options.event + tt(i))
        },
        tryEmit: function(t) {
        ...
        directionTest: function(t) {
          var e = this.options,
            ...
            a = t.deltaX,
            o = t.deltaY;
          return r & e.direction || (e.direction & Rt ? (r = 0 === a ? Et : a < 0 ? Ft : Yt, n = a != this.pX, i = Math.abs(t.deltaX)) : (r = 0 === o ? Et : o < 0 ? Nt : Bt, n = o != this.pY, i = Math.abs(t.deltaY))), t.direction = r, n && i > e.threshold && r & e.direction
        },
        attrTest: function(t) {
        ...
        attrTest: function(t) {
          ...
          return n & (Rt | jt) ? e = t.overallVelocity : n & Rt ? e = t.overallVelocityX : n & jt && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && n & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && xt(e) > this.options.velocity && t.eventType & kt
        },
        emit: function(t) {
      ...
      ht.prototype = {
        ...
        recognize: function(t) {
          ...
          if (!e.stopped) {
            ...
            for (var a = 0; a < i.length;) n = i[a], 2 === e.stopped || r && n != r && !n.canRecognizeWith(r) ? n.reset() : n.recognize(t), !r && n.state & (fe | pe | ge) && (r = e.curRecognizer = n), a++
          }
        },
        get: function(t) {
      ...
      h = function(t) {
        function e(e, n) {
          ...
          return f && f.enable && (n.tooltip(!1), s ? (s.get("press").set({
            threshold: l,
            time: h
          }), s.on("press", a.wrapBehavior(r(r(i)), "_handlePress"))) : a.addEventListener(i.el, "press", a.wrapBehavior(r(r(i)), "_handlePress"))), n.registerPlugins([u, {
            changeData: function() {
              o.limitRange = {}
            },
            clear: function() {
        ...
        return n.getDefaultCfg = function() {
          ...
          return e = a.mix({}, e, {
            ...
            _timestamp: 0,
            lastPoint: null
          }), (a.isWx || a.isMy) && (e.startEvent = "touchstart", e.processEvent = "touchmove", e.endEvent = "touchend"), e
        }, n.start = function(t) {
          ...
          } else null !== i && null !== r && (this.panning = !0, e = t.deltaX - i, n = t.deltaY - r, this.currentDeltaX = t.deltaX, this.currentDeltaY = t.deltaY);
          ...
          if (s !== u[r].min || c !== u[r].max) {
            var l = this.chart,
              ...
              f = "x" === i ? c - h : c + h,
              p = "x" === i ? s - h : s + h;
            u[r] && !a.isNil(u[r].min) && p <= u[r].min && (f = c - s + (p = u[r].min)), u[r] && !a.isNil(u[r].max) && f >= u[r].max && (p = (f = u[r].max) - (c - s));
          ...
          if (e > 0 && d >= 0) {
            ...
            var w = h.slice(d, v + 1),
              P = null;
            if ("timeCat" === r) {
              for (var C = u.length > 2 ? u[1] - u[0] : 864e5, M = u[u.length - 1] + C; M <= w[w.length - 1]; M += C) u.push(M);
              P = u
            }
            i.scale(s, a.mix({}, l, {
              values: w,
      ...
      l = function(t) {
        ...
        return n.getDefaultCfg = function() {
          ...
          if (o.directionEnabled(s, "x") && o.directionEnabled(i, "x")) {
            var h = c.getXScale(),
              f = h.field;
            u[f] || (u[f] = o._getLimitRange(l, h)), h.isCategory ? r._zoomCatScale(h, t, e) : h.isLinear && r._zoomLinearScale(h, t, e, "x");
